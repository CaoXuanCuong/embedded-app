import { Badge, Button, Icon, SkeletonBodyText } from "@shopify/polaris";
import {
  PlayMinor,
  ReplayMinor,
  ChevronLeftMinor,
...
export default function PaginationPageview({
  list,
  active,
  onClick,
  fullWidth,
    ...
    <div className={styles.msr_wrapper_pagination}>
      ...
      >
        ...
        {!loading &&
          list.length > 0 &&
          list.map(
            ({ _id, viewed, createdAt, os, browser, device, location, session, duration }) => {
